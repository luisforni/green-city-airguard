...
def main(page: ft.Page):
    page.title = "GreenCity IoT - Monitoreo Ambiental"
    page.window_width = 450
    page.window_height = 400
    page.vertical_alignment = ft.MainAxisAlignment.CENTER
    page.horizontal_alignment = ft.CrossAxisAlignment.CENTER

    title = ft.Text("Predicciones Ambientales", size=22, weight="bold")
    ...
    def update_dashboard():
        while True:
            ...
            if fire_prediction == "alto":
                ...
                fire_risk_text.color = ft.colors.RED_600
            ...
            if air_prediction == "mala":
                ...
                air_quality_pred_text.color = ft.colors.RED_600
